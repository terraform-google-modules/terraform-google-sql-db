...
resource "google_sql_database_instance" "replicas" {
  ...
  name                 = each.value.name_override == null || each.value.name_override == null ? "${local.master_instance_name}-replica${var.read_replica_name_suffix}${each.value.name}" : each.value.name_override
