...
| data\_cache\_config | Whether data cache is enabled for the instance. Only applicable for ENTERPRISE\_PLUS MYSQL instance. | <pre>list(object({<br>    data_cache_enabled   = bool<br>  }))</pre> | `null` | no |
