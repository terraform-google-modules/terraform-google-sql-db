...
| instance\_type | The type of the instance. The supported values are SQL\_INSTANCE\_TYPE\_UNSPECIFIED, CLOUD\_SQL\_INSTANCE, ON\_PREMISES\_INSTANCE and READ\_REPLICA\_INSTANCE. Module will set the value to READ\_REPLICA\_INSTANCE if primary\_instance\_name is not null | `string` | `"CLOUD_SQL_INSTANCE"` | no |
...
| primary\_instance\_name | Primary instance name. Required for creating failover replica instance. Not needed for primary instance | `string` | `null` | no |
