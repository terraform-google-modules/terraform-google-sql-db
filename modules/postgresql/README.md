...
| create\_kms\_key\_handle | Create autokey key handle. Set this to false if key handle already exists. | `bool` | `true` | no |
...
| kms\_key\_handle\_name | autokey key handle name | `string` | `null` | no |
