...
| instance\_type | The type of the instance. The supported values are SQL\_INSTANCE\_TYPE\_UNSPECIFIED, CLOUD\_SQL\_INSTANCE, ON\_PREMISES\_INSTANCE and READ\_REPLICA\_INSTANCE. Set to READ\_REPLICA\_INSTANCE if primary\_instance\_name value is provided | `string` | `"CLOUD_SQL_INSTANCE"` | no |
...
| primary\_instance\_name | Primary instance name. Required for creating failover replica instance. Not needed for primary instance. When removed it will promote failover replica instance as primary instance | `string` | `null` | no |
...
| zone | The zone for the instance, it should be something like: `us-central1-a`, `us-east1-c`. | `string` | `null` | no |
