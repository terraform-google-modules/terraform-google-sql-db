...
def migrate(state=None, dryrun=False):
    ...
    modules_to_migrate = [
        ...
        if
        module.has_resource("google_sql_database_instance", "replicas") or
        module.has_resource("google_sql_user", "additional_users") or
        module.has_resource("google_sql_database", "additional_databases")
    ]
